<template>
  <div class="hello">
    <div class="banner-container">
      <div class="banner-text text-light">
        <h1>Hoppin World</h1><br/><br/><br/><br/><br/>
    ...
    <div class="banner-container text-light">
    ...
    <div class="banner-container text-light">
        <h2>Anti Progress-Losing Checkpoint System</h2>
        <h5>You won't lose progress by falling behind a checkpoint!</h5>
    </div>
    ...
    <div class="banner-container text-light">
        <h2>High Skill Ceiling</h2>
        <h5>Extra features like jump timing give you an edge against others if you can master it!</h5>
    </div>
